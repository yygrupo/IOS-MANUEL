...
class WTasteViewController: UIViewController, WTasteViewInterface, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIPopoverPresentationControllerDelegate, UISearchControllerDelegate, UISearchResultsUpdating
{
    ...
    var eventHandler: WTasteModuleInterface?
    ...
    private func setupView() {
        ...
        titleLabel.text = "Quero probar".localized
        titleLabel.font = UIFont.boldSystemFontOfSize(16)
        titleLabel.textColor = UIColor.whiteColor()
        self.navigationItem.titleView = titleLabel
        
        let menuBarButtonItem: UIBarButtonItem = UIBarButtonItem(image: UIImage(named: "Menu"), style: .Plain, target: self, action: #selector(WTasteViewController.showMenuAction))
        self.navigationItem.leftBarButtonItem = menuBarButtonItem
        
        let sortBarButtonItem: UIBarButtonItem = UIBarButtonItem(image: UIImage(named: "Sorting Arrows"), style: .Plain, target: self, action: #selector(WTasteViewController.sortAction(_:)))
        
        let optionsBarButtonItem: UIBarButtonItem = UIBarButtonItem(image: UIImage(named: "Menu Circle"), style: .Plain, target: self, action: #selector(WTasteViewController.filtersAction(_:)))
...
extension WTasteViewController: WSortSelectionTableViewControllerDelegate {
